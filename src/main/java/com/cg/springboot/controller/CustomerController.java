...
public class CustomerController {
	...
	@GetMapping("/view1/{user}")
	public Customer viewCustomerById(@Valid @PathVariable("user")  String user)
	{
		Customer customer =  customerService.viewCustomerByUserId(user);
		return customer;
	}
