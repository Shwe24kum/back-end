...
public class LoanAgreementServiceController {
	...
	@GetMapping("/viewapp/{loanId}") 
	public LoanAgreement findApplicationId(@PathVariable("loanId")Long loanApplicationId) throws InvalidLoanAgreementException {
		return this.loanAgreements.retrieveLoanApplicationById(loanApplicationId);
