...
//	}
	...
	@Override
	public LoanAgreement retrieveLoanApplicationById(Long loanApplicationId) {
		LoanApplication loanApp = loanRepo.getById(loanApplicationId);
		LoanAgreement loanAgr= loanRepository.findByLoanApplication(loanApp);
		return loanAgr;
	}
}
